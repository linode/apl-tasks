...
describe('giteaOperator', () => {
  ...
  it('should create a valid group mapping string with all the teams', () => {
    ...
    expect(mappingString).to.be.equal(
      '{"platform-admin":{"otomi":["Owners"]},"team-demo":{"team-demo":["otomi-viewer","team-demo"]},"team-demo2":{"team-demo2":["otomi-viewer","team-demo2"]},"team-demo3":{"team-demo3":["otomi-viewer","team-demo3"]}}',
    )
