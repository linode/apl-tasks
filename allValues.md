...
| `charts.drone.sharedSecret` | `string` | A secret used by drone-admit-members plugin. https://docs.drone.io/runner/kubernetes/configuration/reference/drone-secret-plugin-token/ | `nil` |
...
| `charts.harbor.persistence.imageChartStorage.aws.region` | `string` | An AWS region. | `nil` |
...
| `cluster.k8sContext` | `string` | The cluster k8s context as found in $KUBECONFIG. | `nil` |
...
| `cluster.owner` | `string` | The name of the organization owning the cluster. | `nil` |
...
| `dns.provider.aws.accessKeyID` | `string` | An AWS access key ID. | `nil` |
| `dns.provider.aws.secretAccessKey` | `string` | An AWS secret key. | `nil` |
| `dns.provider.aws.region` | `string` | An AWS region. | `nil` |
| `dns.provider.aws.role` | `string` | Role may be set explicitly if no metadata can be accessed. | `nil` |
...
| `kms.sops.aws.accessKey` | `string` | An AWS access key ID. | `nil` |
| `kms.sops.aws.secretKey` | `string` | An AWS secret key. | `nil` |
| `kms.sops.aws.region` | `string` | An AWS region. | `nil` |
| `kms.sops.provider` | `string` |  | `nil` |
...
| `kms.sops.azure.clientId` | `string` | An Azure client id. | `nil` |
| `kms.sops.azure.clientSecret` | `string` | An Azure client secret. | `nil` |
...
| `otomi.additionalClusters.[].domainSuffix` | `string` |  | `nil` |
| `otomi.additionalClusters.[].name` | `string` | A lowercase name that starts with a letter and may contain dashes. | `nil` |
| `otomi.additionalClusters.[].provider` | `string` |  | `nil` |
| `otomi.adminPassword` | `string` |  | `nil` |
